  ...
  <div id="primary" class="content-area">
    <main id="main" class="site-main" role="main">
      ...
      <div class="books-header cf">
        ...
        <h2 class="search-query"><?php printf( __( 'Search Results for: %s', 'twentyfifteen' ), get_search_query() ); ?></h2>
      </div>  

      <?php
      // Get specified posts data
      global $wp_query;
      $max_num_pages = $wp_query->max_num_pages; // Set pages info for pagination
